...
import { checkForBridge, useBridgeManager } from './hooks/BridgeManager';
...
function ChooseDevice() {
  const { checkedForBridge, bridgeClient, adbDevices, bridgeError, scanning, DeviceScanner, BridgeManagerContextProvider, clearDevices } = useBridgeManager();
...
function AppContents() {
  ...
  useEffect(() => {
    ...
    promise.then(setHasBridge).catch(err => Log.debug("Error during bridge detection", err));
